...
class Plugin extends AbstractEntity
{
    ...
    #[ORM\Column(type: Types::STRING, length: 20)]
    private string $indiumMinVersion;

    #[ORM\Column(type: Types::STRING, length: 20, nullable: true)]
    private ?string $indiumMaxVersion = null;
    ...
    public function getIndiumMinVersion(): string
    {
        return $this->indiumMinVersion;
    }

    public function setIndiumMinVersion(string $indiumMinVersion): self
    {
        $this->indiumMinVersion = $indiumMinVersion;

        return $this;
    }

    public function getIndiumMaxVersion(): ?string
    {
        return $this->indiumMaxVersion;
    }

    public function setIndiumMaxVersion(?string $indiumMaxVersion): self
    {
        $this->indiumMaxVersion = $indiumMaxVersion;
