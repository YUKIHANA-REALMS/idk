...
#[AsCommand(
    name: 'indium:dev:make-theme',
    description: 'Make a new theme for Indium Panel',
    aliases: ['make:theme']
)]
class DevMakeThemeCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $indiumVersion = $io->ask('Indium Panel version', $this->templateManager->getCurrentTemplateVersion());
        ...
        $this->makeThemeHandler->setThemeMetadata([
            'template' => [
                ...
                'version' => $version,
                'license' => $license,
                'indiumVersion' => $indiumVersion,
                'phpVersion' => $phpVersion,
            ]
        ]);

        $this->makeThemeHandler->handle();
        $io->success('Created a new theme for Indium Panel');
