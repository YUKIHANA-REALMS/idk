...
#[AsCommand(
    name: 'indium:system:cleanup-logs',
...
class SystemCleanupLogsCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            if (!$daysAfter || !is_numeric($daysAfter)) {
                ...
                $this->eventDispatcher->dispatch(
                    new LogDeletionProcessFailedEvent(
                        ...
                        $this->eventContextService->buildCliContext('indium:system:cleanup-logs')
                    )
                );
            ...
            $context = $this->eventContextService->buildCliContext('indium:system:cleanup-logs', [
