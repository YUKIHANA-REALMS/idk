...
#[AsCommand(
    name: 'indium:system:update',
    description: 'Update Indium Panel system with enhanced safety features',
...
class SystemUpdateCommand extends Command
{
    ...
    {
        $io->title('Indium Panel System Update');

        if (!$input->getOption('dry-run')) {
            $io->note([
                'This command will update your Indium Panel installation.',
