...
class CronScheduleCommand extends Command
{
    private const SCHEDULED_COMMANDS = [
        'indium:server:suspend-unpaid',
        'indium:plugin:cron:run',

        'indium:system:cleanup-tokens' => [
            'interval' => CronIntervalEnum::HOURLY,
        ],

        'indium:server:delete-inactive' => [
        ...
        'indium:license:verify' => [
            'interval' => CronIntervalEnum::DAILY,
        ],

        'indium:system:cleanup-logs' => [
            'conditions' => [
                [
