...
class EmailVerificationService
{
    ...
    private const JWT_ISSUER = 'indium';
    ...
    public function sendVerificationEmail(UserInterface $user): void
    {
        ...
        $emailMessage = new SendEmailMessage(
            $user->getEmail(),
            $this->translator->trans('indium.email.verification.subject', ['%siteName%' => $context->siteName]),
    ...
    public function resendVerificationEmail(UserInterface $user): void
    {
        ...
        if (!$canResend) {
            throw new RuntimeException(
                $this->translator->trans('indium.email.verification.resend_too_soon', [
