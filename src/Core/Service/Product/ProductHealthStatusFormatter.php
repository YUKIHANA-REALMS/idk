    ...
    public function getHealthBadgeHtml(Product $product, TranslatorInterface $translator): string
    {
        ...
        return match ($status) {
            ProductHealthStatusEnum::HEALTHY => sprintf(
                ...
                $translator->trans('indium.crud.product.health_status.healthy')
            ),
