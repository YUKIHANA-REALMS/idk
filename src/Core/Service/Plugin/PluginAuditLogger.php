        ...
        if ($pluginOrPath instanceof Plugin) {
            ...
            $this->logPluginAction(
                ...
                [
                    ...
                    'indium_min_version' => $pluginOrPath->getIndiumMinVersion(),
                    'indium_max_version' => $pluginOrPath->getIndiumMaxVersion(),
                ]
            );
        } else {
            ...
            $details = [
                ...
                'path' => $pluginOrPath,
                'indium_min_version' => $manifest->getMinIndiumVersion(),
                'indium_max_version' => $manifest->getMaxIndiumVersion(),
            ];
