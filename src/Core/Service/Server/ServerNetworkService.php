    ...
    ): ServerAllocationActionResult
    {
        ...
        try {
            ...
            if ($errorDetail === self::AUTO_ALLOCATION_DISABLED_ERROR) {
                $errorDetail = $this->translator->trans('indium.server.auto_allocation_disabled_for_this_instance');
            }
        }
    ...
    ): ServerAllocationActionResult
    {
        ...
        try {
            ...
            if ($errorDetail === self::DELETE_PRIMARY_ALLOCATION_ERROR) {
                $errorDetail = $this->translator->trans('indium.server.cannot_delete_primary_allocation');
            }
        }
