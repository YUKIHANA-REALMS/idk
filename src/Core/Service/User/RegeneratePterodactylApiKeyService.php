...
readonly class RegeneratePterodactylApiKeyService
{
    ...
    public function regenerateApiKey(UserInterface $user, UserInterface $actor): array
    {
        if (!$user->getPterodactylUserId()) {
            return [
                'success' => false,
                'message' => 'indium.crud.user.pterodactyl_user_not_found',
            ];
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => 'indium.crud.user.api_key_regenerated_successfully',
            ...
            return [
                'success' => false,
                'message' => 'indium.crud.user.api_key_generation_failed',
            ];
        } catch (Exception $e) {
            ...
            return [
                'success' => false,
                'message' => 'indium.crud.user.api_key_regeneration_error',
                'error' => $e->getMessage(),
            ];
        }
    }
