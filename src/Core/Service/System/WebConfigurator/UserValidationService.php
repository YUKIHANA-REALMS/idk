    ...
    ): ConfiguratorVerificationResult
    {
        ...
        if ($localUser !== null) {
            return new ConfiguratorVerificationResult(
                false,
                $this->translator->trans('indium.first_configuration.messages.user_already_exists_in_local_database'),
            );
        }
        ...
        try {
            ...
            if (!empty($users->toArray())) {
                return new ConfiguratorVerificationResult(
                    false,
                    $this->translator->trans('indium.first_configuration.messages.user_already_exists_in_pterodactyl'),
                );
            }

            return new ConfiguratorVerificationResult(
                true,
                $this->translator->trans('indium.first_configuration.messages.user_validation_success'),
            );
        } catch (Exception) {
            return new ConfiguratorVerificationResult(
                false,
