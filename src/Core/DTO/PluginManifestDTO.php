...
readonly class PluginManifestDTO
{
     ...
     * @param array $indium Indium Panel version requirements ['min' => '0.5.9', 'max' => '1.0.0']
    ...
    /**
     * Get minimum required Indium Panel version.
     */
    public function getMinIndiumVersion(): string
    {
        return $this->indium['min'] ?? '0.0.0';
    }

    /**
     * Get maximum compatible Indium Panel version.
     */
    public function getMaxIndiumVersion(): ?string
    {
        return $this->indium['max'] ?? null;
    }
