...
class LoginFormType extends AbstractType
{
    ...
    {
        $translations = [
            'email_address' => $this->translator->trans('indium.login.email_address'),
            'password' => $this->translator->trans('indium.login.password'),
            'remember_me' => $this->translator->trans('indium.login.remember_me'),
        ];
        ...
        $builder
            ->add('email', EmailType::class, [
                ...
                'attr' => [
                    'placeholder' => 'indium.login.email_placeholder',
            ...
            ->add('password', PasswordType::class, [
                ...
                'attr' => [
                    'placeholder' => 'indium.login.password_placeholder',
