...
class VoucherCrudController extends AbstractPanelController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        $this->fields = [
            ...
            ChoiceField::new('type', $translator->trans('indium.crud.voucher.type'))
                ...
                ->setColumns(4)
                ->setHelp($translator->trans('indium.crud.voucher.type_help')),
            TextField::new('code', $this->translator->trans('indium.crud.voucher.code'))
                ->setColumns(4)
                ->setHelp($this->translator->trans('indium.crud.voucher.code_help')),
            NumberField::new('value', $this->translator->trans('indium.crud.voucher.value'))
                ->setNumDecimals(2)
                ->setColumns(4)
                ->setHelp($this->translator->trans('indium.crud.voucher.value_help')),
            TextareaField::new('description', $this->translator->trans('indium.crud.voucher.description'))
                ->hideOnIndex()
                ->setColumns(6)
                ->setHelp($this->translator->trans('indium.crud.voucher.description_help')),
            NumberField::new('minimumTopupAmount', $this->translator->trans('indium.crud.voucher.minimum_top_up_amount'))
                ->setNumDecimals(2)
                ->setColumns(3)
                ->setHelp($this->translator->trans('indium.crud.voucher.minimum_top_up_amount_help')),
            FormField::addRow(),
            NumberField::new('minimumOrderAmount', $this->translator->trans('indium.crud.voucher.minimum_order_amount'))
                ->setNumDecimals(2)
                ->setColumns(2)
                ->setHelp($this->translator->trans('indium.crud.voucher.minimum_order_amount_help')),
            IntegerField::new('maxGlobalUses', $this->translator->trans('indium.crud.voucher.max_global_uses'))
                ->setColumns(2)
                ->setHelp($this->translator->trans('indium.crud.voucher.max_global_uses_help')),
            DateTimeField::new('expirationDate', $this->translator->trans('indium.crud.voucher.expiration_date'))
                ->setColumns(2)
                ->setHelp($this->translator->trans('indium.crud.voucher.expiration_date_help')),
            IntegerField::new('usedCount', $this->translator->trans('indium.crud.voucher.used_count'))
                ->setDisabled()
                ->hideWhenCreating()
                ->setHelp($this->translator->trans('indium.crud.voucher.used_count_help')),
            FormField::addRow(),
            BooleanField::new('newAccountsOnly', $this->translator->trans('indium.crud.voucher.new_accounts_only'))
                ->hideOnIndex()
                ->setColumns(3)
                ->setHelp($this->translator->trans('indium.crud.voucher.new_accounts_only_help')),
            BooleanField::new('oneUsePerUser', $this->translator->trans('indium.crud.voucher.one_use_per_user'))
                ->hideOnIndex()
                ->setColumns(3)
                ->setHelp($this->translator->trans('indium.crud.voucher.one_use_per_user_help')),
        ];
    ...
    public function configureCrud(Crud $crud): Crud
    {
        ...
        $crud
            ->setEntityLabelInSingular($this->translator->trans('indium.crud.voucher.voucher'))
            ->setEntityLabelInPlural($this->translator->trans('indium.crud.voucher.vouchers'))
            ;
    ...
    public function persistEntity(EntityManagerInterface $entityManager, $entityInstance): void
    {
        ...
        try {
            ...
            if ($creationRequestedEvent->isPropagationStopped()) {
                throw new RuntimeException($this->translator->trans('indium.crud.voucher.creation_blocked'));
            }
            ...
            $this->addFlash('success', $this->translator->trans('indium.crud.voucher.created_successfully'));
        } catch (Exception $e) {
            $this->addFlash('danger', $this->translator->trans('indium.crud.voucher.create_error', ['%error%' => $e->getMessage()]));
            throw $e;
        }
    }
    ...
    public function updateEntity(EntityManagerInterface $entityManager, $entityInstance): void
    {
        ...
        try {
            ...
            if ($updateRequestedEvent->isPropagationStopped()) {
                throw new RuntimeException($this->translator->trans('indium.crud.voucher.update_blocked'));
            }
            ...
            $this->addFlash('success', $this->translator->trans('indium.crud.voucher.updated_successfully'));
        } catch (Exception $e) {
            $this->addFlash('danger', $this->translator->trans('indium.crud.voucher.update_error', ['%error%' => $e->getMessage()]));
            throw $e;
        }
    }
    ...
    public function deleteEntity(EntityManagerInterface $entityManager, $entityInstance): void
    {
        ...
        try {
            ...
            if ($deletionRequestedEvent->isPropagationStopped()) {
                throw new RuntimeException($this->translator->trans('indium.crud.voucher.deletion_blocked'));
            }
            ...
            $this->addFlash('success', $this->translator->trans('indium.crud.voucher.deleted_successfully'));
        } catch (Exception $e) {
            $this->addFlash('danger', $this->translator->trans('indium.crud.voucher.delete_error', ['%error%' => $e->getMessage()]));
        }
    }
    ...
    private function getShowRedeemedVouchersAction(): Action
    {
        return Action::new(
            'showVoucherUsages',
            $this->translator->trans('indium.crud.voucher.show_voucher_usages')
        )->setIcon('fa fa-list')
        ->linkToUrl(
