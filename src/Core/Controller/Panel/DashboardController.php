...
class DashboardController extends AbstractDashboardController
{
    ...
    public function index(): Response
    {
        ...
        if (!$this->pterodactylAccountService->isAccountSynchronized($user)) {
            $this->addFlash('warning', $this->translator->trans('indium.system.pterodactyl_account_not_synchronized'));
        }
    ...
    public function configureMenuItems(): iterable
    {
        ...
        if ($this->settingService->getSetting(SettingEnum::SHOW_PHPMYADMIN_URL->value)) {
            $menuItems['footer'][] = MenuItem::linkToUrl(
                $this->translator->trans('indium.crud.menu.phpmyadmin'),
                'fa fa-database',
        ...
        $menuItems['footer'][] = MenuItem::linkToLogout(
            $this->translator->trans('indium.crud.menu.logout'),
            'fa fa-sign-out-alt'
        );
    ...
    public function configureUserMenu(UserInterface $user): UserMenu
    {
        ...
        $userMenu->addMenuItems([
            MenuItem::linkToCrud(
                $this->translator->trans('indium.dashboard.account_settings'),
                'fa fa-user-cog',
                UserAccount::class
            ),
        ]);
