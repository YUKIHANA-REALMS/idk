...
class PluginSettingCrudController extends AbstractSettingCrudController
{
    ...
    public function configureCrud(Crud $crud): Crud
    {
        ...
        if ($this->pluginName) {
            ...
            $crud
                ->setEntityLabelInSingular(sprintf($this->translator->trans('indium.crud.plugin.plugin_setting_with_name'), $pluginLabel))
                ->setEntityLabelInPlural(sprintf($this->translator->trans('indium.crud.plugin.plugin_settings_with_name'), $pluginLabel));
        } else {
            // All plugin settings
            $crud
                ->setEntityLabelInSingular($this->translator->trans('indium.crud.plugin.plugin_setting'))
                ->setEntityLabelInPlural($this->translator->trans('indium.crud.plugin.plugin_settings'));
        }
