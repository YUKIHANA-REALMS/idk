...
class EmailSettingCrudController extends AbstractSettingCrudController
{
    ...
    {
        $testSmtpAction = Action::new('testSmtpConnection', $this->translator->trans('indium.crud.setting.test_smtp_connection'))
    ...
    public function testSmtpConnection(): RedirectResponse
    {
        try {
            ...
            if ($result->isVerificationSuccessful) {
                $this->addFlash('success', $this->translator->trans('indium.crud.setting.smtp_connection_success'));
            } else {
                $this->addFlash('danger', $this->translator->trans('indium.crud.setting.smtp_connection_failed'));
            }
