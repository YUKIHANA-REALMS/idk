...
class PageController extends AbstractController
{
    ...
    public function index(
        ...
        $viewData = [
            'pageTitle' => $this->translator->trans('indium.page.terms_of_service'),
            'pageDescription' => $this->translator->trans('indium.page.terms_of_service_description'),
            'pageIcon' => 'fa-file-contract',
            'pageContent' => $pageContent,
            'footerLinks' => [
                [
                    'url' => 'javascript:history.back()',
                    'text' => 'indium.page.back',
                    'icon' => 'fa-arrow-left',
                    'isRoute' => false,
                ],
            ],
