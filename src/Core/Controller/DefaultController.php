    ...
    public function store(Request $request): Response
    {
        ...
        if ($categoryId) {
            ...
            if (!empty($uncategorizedProducts)) {
                $storeData[] = [
                    'category' => (object) ['name' => 'indium.store.products_with_no_category'],
    ...
    private function buildDefaultNavigationButtons(?object $user): array
    {
        if ($user) {
            return [
                [
                    'type' => 'primary',
                    'label' => 'indium.landing.nav.dashboard',
        ...
        return [
            [
                'type' => 'secondary',
                'label' => 'indium.landing.nav.login',
            ...
            [
                'type' => 'primary',
                'label' => 'indium.landing.nav.get_started',
