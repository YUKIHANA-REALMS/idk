...
readonly class EmailVerificationAlertSubscriber implements EventSubscriberInterface
{
    ...
    public function onKernelRequest(ControllerEvent $event): void
    {
        ...
        $translatedMessage = $this->translator->trans('indium.system.email_not_verified');
        $translatedLinkText = $this->translator->trans('indium.system.or_resend_verification_email');
