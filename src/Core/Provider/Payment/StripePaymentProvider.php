...
class StripePaymentProvider implements PaymentProviderInterface
{
    ...
    private function setStripeApiKey(): void
    {
        ...
        if (empty($apiKey)) {
            throw new Exception($this->translator->trans('indium.recharge.payment_is_not_configured'));
        }
                ...
                'line_items' => [
                    [
                        'price_data' => [
                            ...
                            'product_data' => [
                                'name' => $this->translator->trans('indium.recharge.payment_title'),
                            ],
    ...
    {
        return $this->translator->trans('indium.payment.gateway.stripe.description');
    }
